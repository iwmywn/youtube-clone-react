...
export default function LargeNav({ isLargeNav }: NavProps) {
  return (
    isLargeNav && (
      <nav
        id="nav"
        className="fixed bottom-0 left-0 top-14 z-10 hidden w-60 overflow-x-hidden overflow-y-scroll bg-primary text-sm destop:block"
      >
